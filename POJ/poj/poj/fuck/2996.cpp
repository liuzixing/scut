...
using namespace std;
const char pdwhite[32] = {'K','Q','R','B','N','P','P','P','P','P','P','P','P','P','P','P','P','P','P','P','P','P','P','P','P','P','P','P','P','P','P','P'};
const char pdblack[32] = {'k','q','r','b','n','p','p','p','p','p','p','p','p','p','p','p','p','p','p','p','p','p','p','p','p','p','p','p','p','p','p','p' };
struct condition
{
	bool worb;
	char what;
